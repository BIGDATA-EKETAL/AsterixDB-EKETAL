 ...
 *         &lt;element ref="{cluster}client_ip"/>
 *         &lt;element ref="{cluster}cluster_ip"/>
 *         &lt;element ref="{cluster}java_home" minOccurs="0"/>
 *         &lt;element ref="{cluster}log_dir" minOccurs="0"/>
 *         &lt;element ref="{cluster}client_port"/>
 *         &lt;element ref="{cluster}cluster_port"/>
 *         &lt;element ref="{cluster}http_port"/>
...
public class MasterNode implements Serializable
{
     ...
     * 
     */
    public MasterNode(final String id, final String clientIp, final String clusterIp, final String javaHome, final String logDir, final BigInteger clientPort, final BigInteger clusterPort, final BigInteger httpPort, final BigInteger debugPort) {
        this.id = id;
