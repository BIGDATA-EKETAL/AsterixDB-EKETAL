...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="querygenrunner" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.apache.asterix.experiment.client.SpatialQueryGeneratorDriver %CMD_LINE_ARGS%
