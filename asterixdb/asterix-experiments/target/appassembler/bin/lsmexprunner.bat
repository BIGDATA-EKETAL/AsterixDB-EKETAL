...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="lsmexprunner" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.apache.asterix.experiment.client.LSMExperimentSetRunner %CMD_LINE_ARGS%
