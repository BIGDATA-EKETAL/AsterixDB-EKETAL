...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="rcserver" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.apache.asterix.experiment.client.RecordCountingServer %CMD_LINE_ARGS%
